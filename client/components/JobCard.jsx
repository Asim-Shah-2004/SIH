            ...
            <View className="p-5">
                ...
                {!isExpanded && (
                    <View className="mb-6 space-y-2">
                        ...
                        <TouchableOpacity onPress={() => setIsExpanded(true)} style={{ position: 'absolute', bottom: 10, right: 10 }} className="rounded-lg bg-blue-600 px-3 py-2">
                ...
                {isExpanded && (
                    <>
                        ...
                        {/* Apply Button */}
                        <TouchableOpacity className="rounded-lg bg-blue-600 px-5 py-3 mb-4">
                            <Text className="text-center font-bold text-white">Apply Now</Text>
                        </TouchableOpacity>


                        <TouchableOpacity onPress={() => setIsExpanded(false)} className="py-2 flex items-center">
