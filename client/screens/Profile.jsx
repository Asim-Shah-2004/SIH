                ...
                <View className="flex-row flex-wrap gap-2">
                    {['About', 'Experience', 'Posts', 'Skills'].map((section) => (
                        <Pressable
                            ...
                            className={`rounded-full px-4 py-2 ${activeSection === section.toLowerCase()
                                ? 'bg-primary'
                                : 'border border-gray-200 bg-white'
                                }`}>
                            <Text
                                className={`text-base font-medium ${activeSection === section.toLowerCase() ? 'text-white' : 'text-text/60'
                                    }`}>
                                {section}
                            </Text>
                        </Pressable>
